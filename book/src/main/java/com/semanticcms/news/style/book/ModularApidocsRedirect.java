 ...
 */
package com.semanticcms.news.style.book;
...
@WebServlet("/news/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/news/style/apidocs/com.semanticcms.news.style/com" + Objects.toString(req.getPathInfo(), ""),
